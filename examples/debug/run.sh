...
EXPECTED_WORLD_SIZE=${DEBUG_EXPECT_WORLD_SIZE:-${TOTAL_RANKS}}
EXPECTED_APP_SIZE=${DEBUG_EXPECT_APP_SIZE:-${NEKO_RANKS}}
EXPECTED_WORLD_NODE_SIZE=${DEBUG_EXPECT_WORLD_NODE_SIZE:-${TOTAL_RANKS}}
EXPECTED_APP_NODE_SIZE=${DEBUG_EXPECT_APP_NODE_SIZE:-${NEKO_RANKS}}
...
export NEKO_DEBUG_PROBES=${NEKO_DEBUG_PROBES:-1}
export NEKO_DEBUG_PROBE_BARRIERS=${NEKO_DEBUG_PROBE_BARRIERS:-0}
...
0-7 /usr/bin/env NEKO_COMM_ID=0 NEKO_CTRL_PEER_ROOT=${NEKO_RANKS} NEKO_EXPECT_WORLD_SIZE=${EXPECTED_WORLD_SIZE} NEKO_EXPECT_APP_SIZE=${EXPECTED_APP_SIZE} NEKO_EXPECT_WORLD_NODE_SIZE=${EXPECTED_WORLD_NODE_SIZE} NEKO_EXPECT_APP_NODE_SIZE=${EXPECTED_APP_NODE_SIZE} ${TEST_DIR}/run_neko_mpmd_env.sh ${TEST_DIR}/select_gpu_preserve.sh ${CURRENT_NEKO_EXE} ${NO_POD_CASE}
